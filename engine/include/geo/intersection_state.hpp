...
class IntersectionState {
  ...
  public:
    ...
    Point over_point;              // The point slighty moved in the direction of the surface
                                   // normal, to overcome the slight rounding errors
    Point under_point;             // The piont slightly moved in the opposite direction of
                                   // the surface normal
    ...
    IntersectionState(size_t hit_index, const std::vector<Intersection> &intersections,
                      const Ray &);
};
} // namespace geo
