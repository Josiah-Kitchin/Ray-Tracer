...
RGB color::operator*(double num, const RGB &color) { return color * num; }
...
RGB color::black() { return RGB(0, 0, 0); }

RGB color::white() { return RGB(1, 1, 1); }

RGB color::blue() { return RGB(0, 0, 1); }

RGB color::red() { return RGB(1, 0, 0); }

RGB color::green() { return RGB(0, 1, 0); }
